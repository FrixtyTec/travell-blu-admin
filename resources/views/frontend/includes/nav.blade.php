<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4 d-none">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
                                                    <div id="colorlib-logo"><a href="index.html"><img src=" {!!URL::asset('img/frontend/logo.png');!!}" alt="Purni Bags N More"/></a></div>
						</div>
